...
<img src="{{ public_path('img/deped_matatag.jpg') }}" class="footer-logo">
<img src="{{ public_path('sdo-pic.jpg') }}" class="footer-logo">
...
<img src="{{ public_path('img/fb_logo.png') }}" class="icon">
www.facebook.com/sdoilagan

&nbsp;&nbsp;

<img src="{{ public_path('img/gmail.png') }}" class="icon">
ilagan@deped.gov.ph

&nbsp;&nbsp;

<img src="{{ public_path('img/internet.png') }}" class="icon">
